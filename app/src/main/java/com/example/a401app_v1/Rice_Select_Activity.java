...
public class Rice_Select_Activity extends AppCompatActivity {
    private TextView text;
    private LinearLayout amountEdt,amountCup,se_ric;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_rice);
        readData();
        getValue();
        addbu();
    }
    ...
    public void addbu(){
        ...
        se_ric= findViewById(R.id.se_ric);
        ...
        for(int i=0;i<4;i++)
        {
            ...
            bu[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    se_ric.setVisibility(View.GONE);
                    ...
                    addCal.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) { calculator(finalI);
                        }});
                }
            });
        }
    ...
    public void readData() {
        ...
        bu[3] = (Button) findViewById(R.id.addbu4);
        for(int i = 0 ; i< 4 ; i++) {
            reff = FirebaseDatabase.getInstance().getReference().child("Rice").child(i + "");
            final int finalI = i;
    ...
    public void calculator(int index){
        ...
        if(rdo1.isChecked()&&rdo2.isChecked()==false){
            if (_edt1.getText().length()==0){
                ...
                Rice_Select_Activity.this.setResult(Add_Ingredient_Activity.RESULT_OK, i);
                Rice_Select_Activity.this.finish();
                startActivity(i);
            }
