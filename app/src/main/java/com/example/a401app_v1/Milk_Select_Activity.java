...
public class Milk_Select_Activity extends AppCompatActivity {
    private TextView text;
    private LinearLayout amountEdt,amountCup,se_milk;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_milk);
        readData();
        getValue();
        addbu();
    }
    ...
    public void addbu() {
        ...
        se_milk= findViewById(R.id.se_milk);
    ...
    public void readData() {
        ...
        bu[6] = (Button) findViewById(R.id.addbu7);
        for(int i = 0 ; i< 7 ; i++) {
            reff = FirebaseDatabase.getInstance().getReference().child("Milk").child(i + "");
            final int finalI = i;
    ...
    public void calculator(int index) {
        ...
        if (rdo2.isChecked()) {
            if (_edt2.getText().length()==0){
                ...
                i.putExtra("msg1", gramCalculate(_edt2.getText().toString(), index)); //cal
                i.putExtra("msg2", arrListName.get(index).toString()); //name
                i.putExtra("msg3",gramFatCalculate(_edt2.getText().toString(),index)); //fat
                i.putExtra("msg4",gramProCalculate(_edt2.getText().toString(),index)); //protein
                Milk_Select_Activity.this.setResult(Add_Ingredient_Activity.RESULT_OK, i);
                Milk_Select_Activity.this.finish();
                startActivity(i);
            }
        }
    }
