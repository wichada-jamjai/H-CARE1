...
public class Veggi_Select_Activity extends AppCompatActivity {
    private TextView text;
    private LinearLayout amountEdt,amountCup,se_vig;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.select_veggi);
        readData();
        getValue();
        addbu();
    }
    public void addbu() {
        ...
        se_vig = findViewById(R.id.se_veggi);
        ...
        for(int i=0;i<19;i++)
        {
            ...
            bu[i].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    se_vig.setVisibility(View.GONE);
    ...
    public void readData() {
        ...
        bu[18] = (Button) findViewById(R.id.addbu19);
        for(int i = 0 ; i< 19 ; i++) {
            reff = FirebaseDatabase.getInstance().getReference().child("Veggi").child(i + "");
            final int finalI = i;
    ...
    public void calculator(int index) {
        ...
        if (rdo2.isChecked()) {
            if (_edt2.getText().length()==0){
                ...
                Veggi_Select_Activity.this.setResult(Add_Ingredient_Activity.RESULT_OK, i);
                Veggi_Select_Activity.this.finish();
                startActivity(i);
            }
        }
    }
